# Contributing to md-terminology-trove

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
md-terminology-trove. These guidelines are not strict rules.
...
The md-terminology-trove team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the md-terminology-trove technical leads
...
[issues]: https://github.com/carrollaboratory/md-terminology-trove/issues/
[pulls]: https://github.com/carrollaboratory/md-terminology-trove/pulls/
